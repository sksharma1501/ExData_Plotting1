...
par(mfcol=c(2,2))
# Line plot of Global_active_power
plot(dframe$Day, dframe$Global_active_power, type="l", xlab="", ylab="Global Active Power")
...
plot(dframe$Day, dframe$Voltage, type="l", xlab="datetime", ylab="Voltage")

# Line plot of Global_reactive_power
plot(dframe$Day, dframe$Global_reactive_power, type="l", xlab="", ylab="Global_reactive_power" )
